...
public class ServidorUtil {
	...
	public static AnimeAdapter getAnimeAdapter(String tipo, AnimeDataSource source, String server, boolean isLetraGenero, boolean mostrarVistos,
											   Context c) {
		switch (tipo) {
		case "lista":
			return new AnimeAdapter(c,source, R.layout.lista_anime_layout_list, new ArrayList<AnimeFavorito>(), server);

		case "grid":
			return new AnimeAdapter(c,source, R.layout.lista_anime_layout_grid, new ArrayList<AnimeFavorito>(), server);
		default:
			return new AnimeAdapter(c,source, R.layout.lista_anime_layout_list, new ArrayList<AnimeFavorito>(), server);
		}
	}

	public static AnimeAdapter2 getAnimeAdapter2(String tipo,AnimeDataSource source, String server, boolean isLetraGenero,
			boolean mostrarVistos, Context c) {
		switch (tipo) {
		case "lista":
			return new AnimeAdapter2(c,source, R.layout.lista_anime_layout_list, new ArrayList<AnimeFavorito>(), server);

		case "grid":
			return new AnimeAdapter2(c,source, R.layout.lista_anime_layout_grid, new ArrayList<AnimeFavorito>(), server);
		default:
			return new AnimeAdapter2(c,source, R.layout.lista_anime_layout_list, new ArrayList<AnimeFavorito>(), server);
		}
	}
	...
	public static ProgramacionAdapter getProgramacionAdapter(String tipo,AnimeDataSource source, String server, Context c) {
		switch (tipo) {
		case "lista":
			return new ProgramacionAdapter(c,source, R.layout.lista_programacion_row_list, new ArrayList<Capitulo>(), server);

		case "grid":
			return new ProgramacionAdapter(c,source, R.layout.lista_programacion_row_grid, new ArrayList<Capitulo>(), server);
		default:
			return new ProgramacionAdapter(c,source, R.layout.lista_programacion_row_list, new ArrayList<Capitulo>(), server);
		}
	}
