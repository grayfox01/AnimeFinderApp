...
public class DescargasAdapter extends RecyclerView.Adapter<DescargasAdapter.ViewHolder> {
    ...
    public DescargasAdapter(Context context, ArrayList<Descarga> descargas, int resource) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.descripcion.setText(ServidorUtil.getVideosDescarga(context, new File(descargas.get(i).getFilepath())).size() + " Videos");
